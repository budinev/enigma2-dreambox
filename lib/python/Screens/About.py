...
class SatLodgeInformation(Screen):

    def __init__(self, session):
        Screen.__init__(self, session)
        self.setTitle(_('SatLodge information'))
        SatLodgeInformationText = _('SatLodge information') + '\n'
        SatLodgeInformationText += '\n'
        SatLodgeInformationText += _('Open Vision version: ') + about.getVisionVersion() + '\n'
        SatLodgeInformationText += _('Open Vision revision: ') + about.getVisionRevision() + '\n'
        SatLodgeInformationText += _('Open Vision module: ') + about.getVisionModule() + '\n'
        SatLodgeInformationText += _('Flash type: ') + about.getFlashType() + '\n'
        SatLodgeInformationText += '\n'
        SatLodgeInformationText += _('Image architecture: ') + boxbranding.getImageArch() + '\n'
        if boxbranding.getImageFolder() != '':
            SatLodgeInformationText += _('Image folder: ') + boxbranding.getImageFolder() + '\n'
        if boxbranding.getImageFileSystem() != '':
            SatLodgeInformationText += _('Image file system: ') + boxbranding.getImageFileSystem() + '\n'
        SatLodgeInformationText += _('Image: ') + about.getImageTypeString() + '\n'
        SatLodgeInformationText += _('Feed URL: ') + boxbranding.getFeedsUrl() + '\n'
        SatLodgeInformationText += _('Compiled by: ') + boxbranding.getDeveloperName() + '\n'
        SatLodgeInformationText += _('Build date: ') + about.getBuildDateString() + '\n'
        if boxbranding.getOEVersion().startswith('9'):
            SatLodgeInformationText += _('OE: ') + _('master') + '\n'
        else:
            SatLodgeInformationText += _('OE: ') + _('pyro') + '\n'
        SatLodgeInformationText += '\n'
        if boxbranding.getImageFPU() != '':
            SatLodgeInformationText += _('FPU: ') + boxbranding.getImageFPU() + '\n'
        if boxbranding.getImageArch() == 'aarch64':
            if boxbranding.getHaveMultiLib() == 'True':
                SatLodgeInformationText += _('MultiLib: ') + _('Yes') + '\n'
            else:
                SatLodgeInformationText += _('MultiLib: ') + _('No') + '\n'
        SatLodgeInformationText += '\n'
        if boxbranding.getMachineMtdBoot() != '':
            SatLodgeInformationText += _('MTD boot: ') + boxbranding.getMachineMtdBoot() + '\n'
        if boxbranding.getMachineMtdRoot() != '':
            SatLodgeInformationText += _('MTD root: ') + boxbranding.getMachineMtdRoot() + '\n'
        if boxbranding.getMachineMtdKernel() != '':
            SatLodgeInformationText += _('MTD kernel: ') + boxbranding.getMachineMtdKernel() + '\n'
        if boxbranding.getMachineRootFile() != '':
            SatLodgeInformationText += _('Root file: ') + boxbranding.getMachineRootFile() + '\n'
        if boxbranding.getMachineKernelFile() != '':
            SatLodgeInformationText += _('Kernel file: ') + boxbranding.getMachineKernelFile() + '\n'
        if boxbranding.getMachineMKUBIFS() != '':
            SatLodgeInformationText += _('MKUBIFS: ') + boxbranding.getMachineMKUBIFS() + '\n'
        if boxbranding.getMachineUBINIZE() != '':
            SatLodgeInformationText += _('UBINIZE: ') + boxbranding.getMachineUBINIZE() + '\n'
        self['AboutScrollLabel'] = ScrollLabel(SatLodgeInformationText)
        ...
        if data is not None and data:
            if status is not None:
                if self.iface == 'wlan0' or self.iface == 'wlan3' or self.iface == 'ra0':
                    ...
                    elif status[self.iface]['accesspoint'] == 'Not-Associated':
                    ...
                    if self.has_key('ESSID'):
                        if not status[self.iface]['essid']:
                            essid = _('Unknown')
                        elif status[self.iface]['essid'] == 'off':
                            essid = _('No connection')
                        else:
                    ...
                    if self.has_key('bitrate'):
                        if not status[self.iface]['bitrate']:
                            bitrate = _('Unknown')
                        elif status[self.iface]['bitrate'] == '0':
                    ...
                    if self.has_key('enc'):
                        ...
                        elif status[self.iface]['encryption'] == 'off':
...
class CommitInfo(Screen):
    ...
    def __init__(self, session):
        ...
        self.project = 0
        self.projects = [('https://api.github.com/repos/OpenVisionE2/enigma2-openvision/commits' + branch, 'Enigma2 - Vision'),
